      ...
      <div className="max-w-7xl w-full mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-16 text-center md:text-left">
          ...
          <div className="w-full px-10 sm:px-10 md:w-1/2 flex flex-col items-center md:items-start mb-1 pl-12">
            ...
            <Link
              to="/products"
              className="text-base text-white capitalize px-6 py-2.5 bg-black rounded-lg mb-6"
            >
              Buy Now
            </Link>
        ...
        {/* Icons Section */}
        <div className="mt-40 pl-10 lg:pl-16 lg:pr-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-16">
            {[
              {
